...
<html lang="en">
  ...
  <link href="twitter-bootstrap-v2/docs/assets/css/bootstrap.css" rel="stylesheet">
    ...
    <title>Best food in Bloomington</title>
    ...
    <div class="container-fluid">
        ...
        <div class="span4">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="menu1.php">Appetizer</a></li>
              <li><a href="naan.html">Naans</a></li>
              <li><a href="">Entrees( veg )</a></li>
              <li><a href="#">Entrees ( non veg )</a></li>
              <li><a href="#">Tandoori</a></li>
			  <li><a href="#">Entrees ( Lamb and goat )</a></li>
			  <li><a href="#">Burgers and subs</a></li>
                           <li><a href="#">Drinks</a></li>
                            <li><a href="#">Smoothies</a></li>
                             <li><a href="#">Other drinks</a></li>
               <li><a href="#">Sweets</a></li>
                             <li class="nav-header">Specialties</li>
              <li><a href="#">Pav bhaji</a></li>
              <li><a href="#">Samosa chat</a></li>
              <li><a href="#">Aalo tikki chat</a></li>
              <li><a href="#">Chole bhatura</a></li>
              <li></li>
      ...
      <ul class="thumbnails">
        ...
        <li>
          <div class="thumbnail">
              <div class="caption">
                   <img src="bread pakora.jpg" width="200" height="200">
              <h5>Bread pakora</h5>
              <p>Delicious spicy potatoes are mashed and stuffed inside bread and fried</p>
              <p><a href="#" class="btn btn-success">Add to order</a> <a href="#" class="btn btn-warning">$5</a></p>
            </div>
          </div>
        </li>
            </div>
        ...
        <li>
          <div class="thumbnail">
            <div class="caption">
                <img src="chicken_roll.jpg">
              <h5>Chicken_roll</h5>
              <p>Indian flat bread stuffed with chicken, tomatoes, onions, vinegar & chutney</p>
              <p><a href="#" class="btn btn-success">Add to order</a> <a href="#" class="btn btn-warning">$5</a></p>
            </div>
          </div>
        </li>
          ...
          <div class="thumbnail">
            <div class="caption">
              ...
              <h5>Samosa (2pc)</h5>
              <p>A golden crispy, flaky deep fried crust stuffed with potatoes and peas served with ketchup.</p>
              <p><a href="#" class="btn btn-success">Add to order</a> <a href="#" class="btn btn-warning">$3.5</a></p>
            </div>
          </div>
        </li>
          </div>
         ...
         <li>
          <div class="thumbnail">
            <div class="caption">
              <img src="bhel.jpg">
                <h5>Bhel Puri</h5>
              <p>Puffed rice with various vegetables and a tangy tamarind sauce.</p>
              <p><a href="#" class="btn btn-success">Add to order</a> <a href="#" class="btn btn-warning">$4</a></p>
            </div>
          </div>
        </li>
          </div>
         ...
         <li>
          <div class="thumbnail">
            <div class="caption">
                 <img src="aalo.jpg">
              <h5>Aalloo Roll</h5>
              <p>Indian flat bread stuffed with potato, tomatoes, onions, vinegar & chutney.</p>
              <p><a href="#" class="btn btn-success">Add to order</a> <a href="#" class="btn btn-warning">$5</a></p>
            </div>
          </div>
        </li>
          ...
          <div class="thumbnail">
              <div class="caption">
                  <img src="aloo_tikki.jpg" width="200" height="100">
                  <h5>Aalo tikki chat</h5>
              <p>Potato cutlets served with spiced chickpeas and delicious chutneys.</p>
              <p><a href="#" class="btn btn-success">Add to order</a> <a href="#" class="btn btn-warning">$6</a></p>
            </div>
          </div>
        </li>
      </ul>
